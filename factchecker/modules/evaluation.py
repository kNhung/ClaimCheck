...
def judge(record, decision_options, rules="", think=True, key_number=1):
    """
...
def extract_verdict(conclusion, decision_options, rules="", key_number=1):
    """
    ...
    return prompt_gemini(prompt, think=False, key_number=key_number)