...
### Verdict:
<1 từ trong PHÁN QUYẾT HỢP LỆ, đặt trong dấu nháy ngược. Không thêm chữ khác.>
...
ĐỊNH DẠNG ĐẦU RA:
In DUY NHẤT MỘT TỪ PHÁN QUYẾT (KHÔNG thêm lời giải thích), đặt trong dấu nháy ngược `...`.
...
def judge(record, decision_options,model_name, rules="", think=True, key_number=1):
    """
    Determines the a claim based on the provided record and decision options.
...
def extract_verdict(conclusion, decision_options,model_name, rules="", key_number=1):
    """
    ...
    return prompt_model(prompt, model_name=model_name, think=False, key_number=key_number)